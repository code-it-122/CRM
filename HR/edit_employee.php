...
<div class="admin-container">
    ...
    <div class="view py-4 px-4">
        <?php
        $ph_icon = 'fa-user-pen';
        $ph_title = 'Edit Employee';
        $ph_subtitle = 'Update this employee\'s record.';
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="department" name="department" class="form-control" value="<?php echo htmlspecialchars($employee['department']); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="designation" class="form-label fw-semibold text-dark">Designation</label>
                                    <input type="text" id="designation" name="designation" class="form-control" value="<?php echo htmlspecialchars($employee['designation']); ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="joining_date" class="form-label fw-semibold text-dark">Joining Date</label>
                                <input type="date" id="joining_date" name="joining_date" class="form-control" value="<?php echo $employee['joining_date']; ?>" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="salary" class="form-label fw-semibold text-dark">Salary ($)</label>
                                    <input type="number" step="0.01" min="0" id="salary" name="salary" class="form-control" value="<?php echo $employee['salary']; ?>" required>
                                </div>
