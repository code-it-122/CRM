...
<div class="admin-container">
    ...
    <div class="view py-4 px-4">
        <?php
        $ph_icon = 'fa-box-open';
        $ph_title = 'Add Product';
        $ph_subtitle = 'Add a new item to your catalog.';
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="view_product.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="product_name" name="product_name" class="form-control" placeholder="e.g. Wireless Mouse" required>
                            </div>
                            <div class="mb-3">
                                <label for="category" class="form-label fw-semibold text-dark">Category</label>
                                <input type="text" id="category" name="category" class="form-control" placeholder="e.g. Electronics" required>
                            </div>
                            <div class="mb-3">
                                <label for="description" class="form-label fw-semibold text-dark">Description</label>
                                <textarea id="description" name="description" class="form-control" rows="3" placeholder="Short product description"></textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" min="0" id="stock" name="stock" class="form-control" placeholder="0" required>
                                </div>
                            </div>

                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-success flex-fill py-2 fw-semibold">
                                    <i class="fa-solid fa-circle-check me-2"></i>Add Product
                                </button>
